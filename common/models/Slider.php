...
class Slider extends AppModel
{
    ...
    public function uploadImgPrev()
    {
        if ($this->validate()) {
            ...
            Image::getImagine()->open($this->prev->tempName)->save($path);
    ...
    public function uploadImgPrevMobile()
    {
        if ($this->validate()) {
            ...
            Image::getImagine()->open($this->prev_mobile->tempName)->save($path);
            $this->attachImage($path, true, 'slider_mobile');
    ...
    public function uploadImgPrevTablet()
    {
        if ($this->validate()) {
            ...
            Image::getImagine()->open($this->prev_tablet->tempName)->save($path);
            $this->attachImage($path, true, 'slider_tablet');
