...
<head>
 ...
 <title><?= Html::encode($this->title) ?></title>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="/img/favicons/pdf.png">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
               ...
               <?php  if(Yii::$app->user->can('viewUsers')):?> <li><a href="<?=Url::to(['/users/index'])?>"><i class="fa fa-gears"></i>Управление пользователями</a></li><?php endif;?>
